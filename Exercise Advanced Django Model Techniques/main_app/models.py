...
class DiscountedProduct(Product):
    ...
    def calculate_price_without_discount(self) -> Decimal:
        return self.price * Decimal(1.20) # With increase it with 20%

    def calculate_tax(self) -> Decimal:
        return self.price * Decimal(0.05) # The tax is 5% of the price

    @staticmethod
    def calculate_shipping_cost(weight: Decimal) -> Decimal:
        return weight * Decimal(1.50) # Multiplies the price by 1.50
